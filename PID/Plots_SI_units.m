...
saveas(f,'Plots - SI units/Position_DI_SI','jpg');
saveas(f,'Plots - SI units/Position_DI_SI','epsc');
saveas(f,'Plots - SI units/Position_DI_SI','pdf');
...
saveas(g,'Plots - SI units/Attitude_DI_SI','jpg');
saveas(g,'Plots - SI units/Attitude_DI_SI','epsc');
saveas(g,'Plots - SI units/Attitude_DI_SI','pdf');
...
saveas(h,'Plots - SI units/Controls_DI_SI','jpg');
saveas(h,'Plots - SI units/Controls_DI_SI','epsc');
saveas(h,'Plots - SI units/Controls_DI_SI','pdf');
...
saveas(i,'Plots - SI units/Position_3d_DI_SI','jpg');
saveas(i,'Plots - SI units/Position_3d_DI_SI','epsc');
saveas(i,'Plots - SI units/Position_3d_DI_SI','pdf');
% % % % % % % % % % % % % % % figure(5)
% % % % % % % % % % % % % % % %hTitle =title('ATTITUDE TRACKING');
% % % % % % % % % % % % % % % %set(hTitle,'FontSize',17.5);
