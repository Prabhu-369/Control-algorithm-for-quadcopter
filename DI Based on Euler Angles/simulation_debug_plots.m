...
saveas(a,'Plots - Normal/Position_DI','fig');
% Attitude
% figure(2)
...
saveas(b,'Plots - Normal/Attitude_DI','fig');
...
saveas(c,'Plots - Normal/Controls_DI','fig');
...
saveas(d,'Plots - Normal/Position_3d_DI','fig');
